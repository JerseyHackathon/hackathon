...
const FoodPantryMap: React.FC<FoodPantryMapProps> = ({
  setSelectedPantryName,
}) => {
  ...
  const [selectedPantry, setSelectedPantry] = useState<PantryDetails | null>(
    null
  );
      ...
      if (
        ...
        setSelectedPantry({
          ...
          opening_hours: place.opening_hours ?? {
            weekday_text: ["No opening hours available"],
          },
        });
